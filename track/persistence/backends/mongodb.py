...
from track.persistence.backends.utils import DuplicateKeyError, DatabaseError, AbstractDB
...
class MongoDB(AbstractDB):
    ...
    def __init__(self, uri):
        ...
        super(MongoDB, self).__init__(uri)
    ...
    def initiate_connection(self):
        ...
        self._conn = pymongo.MongoClient(self.resource)
